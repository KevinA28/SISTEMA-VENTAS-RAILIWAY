{{-- =====================================================================
     ARCHIVO: resources/views/tours/create.blade.php
     ===================================================================== --}}
@extends('layouts.app')
@section('titulo', 'Nuevo Tour')

@push('styles')
<style>
    @import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600&family=DM+Mono:wght@400;500&display=swap');

    .create-wrap { font-family: 'DM Sans', sans-serif; }
...
@section('contenido')
<div class="create-wrap max-w-2xl mx-auto px-4 py-6">
    ...
    <div class="page-header">
        <div class="hdr-inner">
            ...
            <div>
                <div class="hdr-title"><i class="bi bi-plus-circle me-1"></i> Nuevo tour</div>
                <div class="hdr-sub">Aparecerá en el autocompletado al crear reservas</div>
            </div>
        </div>
    </div>
        ...
        <div class="form-card">
            ...
            <div class="form-section">
                ...
                <div class="field">
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre') }}"
                           ...
                           placeholder="Ej: Cusco 04D/03N, Aguas Termales – Yumagual…"
                           maxlength="200" required>
                    <div class="field-hint">Es el texto que verá el operador al escribir en «Tipo de paquete».</div>
                ...
                <div class="field">
                    ...
                    <textarea name="descripcion" rows="3" maxlength="1000"
                              placeholder="Itinerario resumido, incluye, no incluye…">{{ old('descripcion') }}</textarea>
            ...
            <div class="form-section">
                ...
                <div class="field" style="margin-top:14px; max-width:180px;">
                    ...
                    <input type="number" name="duracion_horas" value="{{ old('duracion_horas') }}"
            ...
            <div class="form-section">
                ...
                <div class="toggle-row">
                    ...
                    <div>
                        ...
                        <div class="toggle-hint">Visible en el autocompletado de reservas desde el momento de creación</div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-footer">
                <button type="submit" class="btn-save">
                    <i class="bi bi-check-lg"></i> Guardar tour
                </button>
