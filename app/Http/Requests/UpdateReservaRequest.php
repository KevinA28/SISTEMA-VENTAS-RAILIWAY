...
class UpdateReservaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'aerolinea'                => 'nullable|string|max:150',
            ...
            'tipo_cama'                => 'nullable|in:KB,QB,TB',
            'plan_alimentacion'        => 'nullable|in:RO,BB,HB,FB,AI',
            ...
            'titular_telefono_codigo'      => 'nullable|string|max:10',
            ...
            'titular_telefono2_codigo'     => 'nullable|string|max:10',
            'notif_whatsapp'               => 'nullable',
            'notif_email'                  => 'nullable',
            'solo_pasajero'                => 'nullable|boolean',
            ...
            'pasajeros.*.discapacidades'       => 'nullable|string|max:200',
            'pasajeros.*.discapacidad_otro'    => 'nullable|string|max:100',
            'pasajeros.*.seguro_salud'         => 'nullable|string|max:50',
            ...
            'titular_discapacidades'       => 'nullable|string|max:200',
            'titular_discapacidad_otro'    => 'nullable|string|max:100',
            'titular_seguro_salud'         => 'nullable|string|max:50',
    ...
    public function messages(): array
    {
        return [
            ...
            'pasajeros.*.tipo.in'               => 'El tipo de pasajero no es válido.',
