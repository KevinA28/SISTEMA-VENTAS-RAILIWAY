...
class StoreReservaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'pasajeros.*.discapacidades'       => 'nullable|string|max:200',  // ← NUEVO
            'pasajeros.*.discapacidad_otro'    => 'nullable|string|max:100',  // ← NUEVO
            'pasajeros.*.seguro_salud'         => 'nullable|string|max:50',   // ← NUEVO
